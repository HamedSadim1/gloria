...
A modern React application demonstrating routing with React Router DOM, built with Vite, TypeScript, and Tailwind CSS. The app showcases nested routes, protected routes, dynamic routing, and SEO metadata.
...
- **SEO**: Per-route metadata for search engines and social sharing
