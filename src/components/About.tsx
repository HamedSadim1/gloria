  ...
  return (
    <div className="bg-grid min-h-screen px-6 pt-32">
      <div className="mx-auto max-w-4xl">
        ...
        >
          <motion.div
            className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#bf00ff]/30 bg-[#bf00ff]/10 px-4 py-1.5 text-sm text-[#bf00ff]"
        ...
        <div className="mb-16">
          <motion.h2
            className="mb-6 text-sm font-semibold tracking-widest text-[#00f5ff] uppercase"
            initial={{ opacity: 0 }}
        ...
        {/* Mission */}
        <motion.div
          className="rounded-xl border border-gray-800 bg-[#12121a] p-8"
          initial={{ opacity: 0, y: 30 }}
